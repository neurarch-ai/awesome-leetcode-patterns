...
solved. Grinding problem count is the slow path. Learning the ~31 patterns below,
...
*Every one of the 31 patterns comes with a figure like this, plus a memorizable
...
*The tools for harder rounds: dynamic range queries, DP where the state is a mode
you move between, and string matching.*
...
| 31 | [String matching (KMP and rolling hash)](patterns/31-string-matching.md) | Substring search when O(n*m) is too slow, periodicity, repeated or duplicate substrings, shortest palindrome |
